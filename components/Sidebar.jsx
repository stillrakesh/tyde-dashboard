  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{
            background: 'linear-gradient(135deg, #94161c 0%, #b91c1c 100%)',
            color: 'white',
            padding: '10px',
            borderRadius: '12px',
            boxShadow: '0 8px 16px rgba(148, 22, 28, 0.3)'
          }}
        >
          <Store size={20} />
        </div>
        <div>
          <div style={{ fontWeight: '900', fontSize: '16px', letterSpacing: '-0.3px' }}>
            TYDE CLOUD
          </div>
          <div style={{ fontSize: '11px', color: '#94a3b8', fontWeight: '700' }}>
            POS Analytics Intelligence
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div>
          <div style={{ fontSize: '11px', fontWeight: '900', color: '#34d399', textTransform: 'uppercase' }}>
            POS Sync Active
          </div>
          <div style={{ fontSize: '10px', color: '#a7f3d0', fontWeight: '600' }}>
            Receiving live POS data
          </div>
        </div>
      </div>
            ...
            return (
              <Link
                ...
                style={{
                  ...
                  background: isActive
                    ? 'linear-gradient(135deg, rgba(148, 22, 28, 0.6), rgba(185, 28, 28, 0.3))'
                    : 'transparent',
                  border: isActive
                    ? '1px solid rgba(148, 22, 28, 0.5)'
